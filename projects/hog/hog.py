...
def take_turn(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    if num_rolls == 0:
        ...
        return roll_dice(num_rolls, dice)# "dice = six_sided" is not true
    # END PROBLEM 3
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    if i am in the lead or my score has already been 95: roll 0. 1 or 2 dice.
    if rolling 0 dice can gain more points than rolling more than 6 dice, then choose boar_brawl strategy.
    """
    # BEGIN PROBLEM 12
    sus_points = sus_update(0, score, opponent_score)
    base_6 = sus_update(6, score, opponent_score)
    i = 1
    num_rolls = 0
    while GOAL - 5 <= score <= GOAL and i < 3:
        temp = sus_update(i, score, opponent_score)
        if(temp > sus_points and temp > base_6):
            num_rolls = i 
            sus_points = temp
        else:
            num_rolls = 6
